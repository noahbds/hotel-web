...
export interface StaffRow { id: string; hotel_id: string; name: string; role: StaffRole; active: boolean; created_at: string; updated_at: string; }
export interface RoomRow { id: string; hotel_id: string; name: string; floor: number; status: RoomStatus; assignee_staff_id: string | null; verifier_staff_id: string | null; priority: boolean; note: string; created_at: string; updated_at: string; }
export interface IssueRow { id: string; hotel_id: string; room_id: string; description: string; photo_url: string | null; assignee_staff_id: string | null; resolved: boolean; resolved_at: string | null; created_at: string; updated_at: string; }
...
export interface ReportIssueInput { hotelId: string; roomId: string; description: string; photoUrl: string | null; assigneeId: string | null; actorId: string | null; }
